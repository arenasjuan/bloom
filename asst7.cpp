...
// -------- Shaders
static const int g_numShaders = 4, g_numRegularShaders = 3;
static const int PICKING_SHADER = 2;
static const char * const g_shaderFiles[g_numShaders][2] = {
  {"./shaders/basic-gl3.vshader", "./shaders/diffuse-gl3.fshader"},
  {"./shaders/basic-gl3.vshader", "./shaders/solid-gl3.fshader"},
  { "./shaders/basic-gl3.vshader", "./shaders/bloom.fshader" },
...
int main(int argc, char * argv[]) {
  try {
	...
	for (unsigned int i = 0; i < 2; i++)
	{
		...
		glTexImage2D(
			GL_TEXTURE_2D, 0, GL_RGB16F, g_windowWidth, g_windowHeight, 0, GL_RGB, GL_FLOAT, NULL
		);
